...
- **Data Layer Replacement**: **Legend-State** with its TanStack Query sync plugin will replace the previously planned **TanStack Query** for all data fetching, caching, and state management. This provides a unified solution for both online and offline data operations.
