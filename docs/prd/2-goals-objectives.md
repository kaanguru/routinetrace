...
Create a robust and user-friendly "routine to-do list" Android application using React Native Expo.
...
Use @legendapp/state with its TanStack Query sync plugin
